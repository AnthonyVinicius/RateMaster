    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/brand/update/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/brand/delete/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/category").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/category/update/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/category/delete/{id}").permitAll()
